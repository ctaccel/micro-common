...
func (r *rabbitMQChannel) Channle() *amqp.Channel {
	return r.channel
}

func (r *rabbitMQChannel) PullQueue(queue string, autoAck bool) (amqp.Delivery, bool, error) {
	return r.channel.Get(queue, autoAck)
}
